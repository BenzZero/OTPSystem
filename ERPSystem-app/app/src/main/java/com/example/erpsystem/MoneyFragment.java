...
public class MoneyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            MoneyFragmentAdapter adapter = new MoneyFragmentAdapter(getContext(), results);
            ListView listView = (ListView) rootView.findViewById(R.id.lv_money);
    ...
    public class RequestAsync extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                result =  RequestHandler.sendGet(BuildConfig.SERVER_URL + "/messages?type=MONEY");
                return result;
            }
            catch(Exception e){
